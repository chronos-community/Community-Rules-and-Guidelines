<h1> Chronos Davranış Kuralları </h1>
...
* Başkalarına karşı saygılı olmak: Farklı görüşten insanlarla çalışmanın zor olduğunu biliyoruz. Amacımız farklılıklardan faydalanarak, düşüncelerin açıkça paylaşıldığı demokratik bir ortam oluşturmak ve saygının her zaman ön planda olmasıdır.  

* Kibar davranmak	

* Farklı bakış açılarına ve deneyimlere saygılı olmak: Birbirimizin düşüncelerine saygı duymamız oldukça önemli. Tabi ki  bunun anlamı herşeyi kabul edeceğimiz anlamına gelmediği gibi farklı düşüncelere sahip olan insalar için de özgür bir platform oluşturmaktır. Bunun da temel taşı herkesin birbirine saygılı davranmasıdır.

* Yapıcı eleştiriyi nezaketle kabul etmek :  Yapıcı ve iyi niyetli eleştirilere her zaman açığız. Eleştirmek değil değiştirmek için mottosunu izleyen bireylerden oluşmaktayız. Sizler eleştireceksiniz ki bizler olumlu yönde daha da çok kendimizi geliştireceğiz. 

* Topluluk için en iyisinin ne olduğuna odaklanmak: Topluluğumuza katılan her birey önemlidir. Ama bireylerin istek ve amaçlarından daha değerli olan ise topluluğu oluşturan bireylerin çoğulcu amaçları ve ortak paydada toplanmalarıdır. 

* Diğer topluluk üyelerine karşı empati göstermek: Toplumumuzda olmayan şeylerden birisi maalesef hoşgörü kültürünün olmamasıdır. İnancımız, Chronos topluluğunda yer alan bireylerin özel, seçilmiş bireyler olduğudur. Bu yüzden empati göstermeyen ve zehirleyici davranışlara sahip olan bireyler topluluğumuzda yer alamaz. 

* Her projeye üye katılımları olduğu gibi üyelerin ayrılması da farklı sebeplerden gerçekleşebilir. Bir arkadaşımız projeden ayrıldığında, insanlara ayrıldıklarını söylemeli ve diğerlerinin kaldığı yerden devam edebilmelerini sağlamak için uygun adımları atmalıdır. Bunu yaparken, projeye katılmaya devam edenlere karşı saygılı olmalı ve projenin hedeflerini veya başarılarını yanlış tanıtmamalıdırlar. Aynı şekilde, topluluk üyeleri, herhangi bir bireyin projeden ayrılma seçimine saygı duymalıdır.

* Seçtiğimiz kelimelere dikkat edin: Topluluktaki her birey gönüllü olarak katılmaktadır. Tüm etkileşimlerde profesyonelliğe değer veriyoruz ve kendi konuşmamızın sorumluluğunu alıyoruz. Başkalarına karşı nazik olun. Diğer katılımcıları aşağılamayın. Taciz ve diğer dışlayıcı davranışlar kabul edilemez.
</code>
...
* Tartışma uğruna tartışma başlatmak (içtenlik kisvesi altında defalarca samimiyetsiz sorular sormak)

* Aşağılayıcı yorumlar yapmak ve kişisel saldırılar yapmak

* Sürekli olarak çatışmayı kışkırtmak ve insanları tartışmalara sokmak

* Herkesin önünde veya özel tacizde bulunmak 

* Fiziksel veya elektronik adres gibi başka birinin özel bilgilerini açık izin olmadan yayınlamak
